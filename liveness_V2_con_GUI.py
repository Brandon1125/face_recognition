...
###############################################################################################################     
                    ...
                    def imagen(w, h, imagen):
                        ...
                        i3 = canvas.create_image(w, h, anchor=tk.SW, image=imgtk3)
                        canvas.tag_raise(i3)
                        
                        return i3
                    
                    def texto(X, Y, texto=text):
                        name_label2.config(text=text, wraplength=270, font=("Helvetica", 9), justify="center")
                        name_label2.place(x=X, y=Y)
                        
                        return name_label2
                                              
                    if registro_exitoso == True: 
                        
                        #Falta validar que cuando el nombre de Messi se cambie a Unknown aún siga mostrando la foto de Messi
                        #if name is not None:
                        i3 = imagen(0, 320, img3)
                        name_label2 = texto(170, 270)
                        
                    if no_registrado == True:   
                        i3 = imagen(-32, 355, img4)
                        name_label2 = texto(120, 270)
                        
                    if foto_falsa == True:
                        i3 = imagen(-37, 350, img5)
                        name_label2 = texto(110, 260)
                ...
                def para():
                    ...
                    cuadro_texto = tk.Entry(ventana_secundaria)
                    cuadro_texto.pack()
                
                    # Agregar el botón para guardar la imagen
                    boton_guardar = tk.Button(ventana_secundaria, text="Guardar", command=guardar_imagen)
                    boton_guardar.pack()
                ...
                button = tk.Button(root, text="Tomar foto", command=para)
                button.pack()
